...
const DS_CODES = [
  { value: "BT", code: "BT", title: "Book Title", note: "system/locked after save" },
  { value: "CT", code: "CT", title: "Chapter Title", note: "user; locked after chapter finalisation" },
  { value: "X1", code: "X1", title: "Content Block 1" },
  { value: "X2", code: "X2", title: "Content Block 2" },
];
...
function DSCodeSelect({ value, onChange, disabled }) {
  return (
    <Select
      ...
      optionRender={(option) => {
        ...
        return (
          <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
            <div style={{ width: 64, fontFamily: "monospace", fontWeight: 700 }}>
              {data.code}
            </div>
            <div style={{ lineHeight: 1.25 }}>
              <div style={{ color: "rgba(0,0,0,0.88)" }}>{data.title}</div>
              {data.note ? (
...
function DSCodeReadonly({ value }) {
  const opt = DS_CODES.find((o) => o.value === value);
  const label = opt ? `${opt.code} — ${opt.title}` : (value || "—");
  return (
    <div
      style={{
        width: "100%",
            ...
            <div>
              ...
              <Row gutter={12} align="bottom">
                ...
                <Col xs={24} sm={4} style={{ marginTop: 10 }}>
                  ...
                  <DSCodeReadonly value={activeDSCode} />
                </Col>
        ...
        <Col span={24} style={{ padding: 20 }}>
          ...
          >
            {/* <Row gutter={12} style={{ marginBottom: 12 }}>
              <Col xs={24} sm={12}>
                <Text type="secondary">DSCode</Text>
                <DSCodeSelect value={activeDSCode} onChange={setActiveDSCode} disabled={!window2Enabled} />
              </Col>
  ...
  <div style={{ marginTop: 10 }}>
    ...
    >
      ...
      >
       ...
       {/* ✅ PLACE 3D HERE (StructureCodePicker) */}
    <StructureCodePicker
      open={pickerOpen}
